namespace Subfuzion.Helpers.Win32
{
	using System;
	...
	public enum ShowCommands
	{
		...
		/// is similar to <see cref="ShowCommands.Normal"/>, except 
		...
		/// <see cref="ShowCommands.ShowMinimized"/>, except the 
		...
		/// similar to <see cref="ShowCommands.Show"/>, except the 
		/// window is not activated.
		/// </summary>
		ShowNA = 8,
